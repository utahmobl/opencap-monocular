...
class DetectionModel(object):
    def __init__(
        self,
        device,
        vit_cfg="configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_huge_coco_256x192.py",
        vit_ckpt="checkpoints/vitpose-h-multi-coco.pth",
    ):

        pose_model_cfg = osp.join(VIT_DIR, vit_cfg)
        pose_model_ckpt = osp.join(ROOT_DIR, vit_ckpt)
